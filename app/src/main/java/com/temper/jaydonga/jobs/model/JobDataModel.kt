...
data class Data(
    ...
    val job: Job,
    val recurring_shift_schedule: Recurring_shift_schedule,
...
data class Recurring_shift_schedule(
    val id : String,
    val tempers_needed : Int,
    val earnings_per_hour : Earnings_per_hour,
    val total_cost_per_hour : Total_cost_per_hour,
    val starts_at : String,
    val ends_at : String,
    val monday : Boolean,
    val tuesday : Boolean,
    ...
    val sunday : Boolean,
    val schedule_start_date : String,
    val schedule_end_date : String,
    val is_active : Boolean,
    val variable_pricing : Boolean,
    val commitment_preferred : Boolean,
    val cancellation_policy : Int,
    val shift_group_id : String,
)

data class Total_cost_per_hour (
